...
This project builds a machine learning pipeline to detect **musculoskeletal abnormalities** from radiographic (X-ray) images of the upper extremities.

The goal is to classify each radiograph as either **normal** or **abnormal**.
...
The system loads X-ray images, preprocesses them, trains a convolutional neural network, and generates predictions for a test dataset.
